...
module.exports = class Personaje {
    ...
    constructor(mi_shortName, mi_longName, mi_color, mi_piloto1, mi_piloto2, mi_imgLivery, mi_link, mi_logo, mi_imgPiloto1, mi_imgPiloto2) {
        this.shortName = mi_shortName;
        this.longName = mi_longName;
        this.color = mi_color;
        this.piloto1 = mi_piloto1;
        this.piloto2 = mi_piloto2;
        this.imgLivery = mi_imgLivery;
        this.link = mi_link;
        this.logo = mi_logo;
        this.imgPiloto1 = mi_imgPiloto1;
        this.imgPiloto2 = mi_imgPiloto2;
    }
