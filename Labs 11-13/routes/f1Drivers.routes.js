...
const pilotosController = require('../controllers/pilotos.controllers');
...
router.get('/mv1', pilotosController.get_verstappen);
router.get('/op81', pilotosController.get_piastri);
